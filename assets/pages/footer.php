  ...
  <div class="modal fade" id="chatbox" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="input-group mb-3" id="msgsender">
          <input type="text" class="form-control" placeholder="Enter message"  id="msginput" required>
          <div class="input-group-append">
            <label class="input-group-text" for="attachmentInput">
              <i class="bi bi-paperclip" id= "attachment"></i>
            </label>
